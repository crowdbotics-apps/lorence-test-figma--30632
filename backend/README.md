...
## Project Structure
    ...
    ├── lorence_test_figma__30632  # Django project configurations
...
1. Clone this repo and `cd lorence_test_figma__30632`
...
2. Clone this repo and `cd lorence_test_figma__30632`
